...
- A composite live helper is worth it. `analyze_target` turned the common loop "search -> navigate -> decompile -> refs" into one machine-readable response and immediately made WorkflowKit iteration faster.
